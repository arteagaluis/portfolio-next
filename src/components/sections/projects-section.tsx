...
export function ProjectsSection() {
  const projects: Project[] = [
    ...
    {
      title: 'Project Two',
      description: 'An overview of the second project, focusing on the technologies used and problems solved.',
      tags: ['TypeScript', 'Node.js', 'PostgreSQL'],
      image: PlaceHolderImages.find(p => p.id === 'project-2')!
    },
    {
      title: 'Project Three',
      description: 'Details about the third project, showcasing complex functionalities and design patterns.',
      tags: ['GraphQL', 'Apollo', 'Prisma'],
      image: PlaceHolderImages.find(p => p.id === 'project-3')!
    },
    {
      title: 'Project Four',
      description: 'This project demonstrates expertise in building scalable and maintainable applications.',
      tags: ['Vue.js', 'Nuxt.js', 'Firebase'],
      image: PlaceHolderImages.find(p => p.id === 'project-4')!
    },
    {
      title: 'Project Five',
      description: 'A mobile-first application designed for a seamless user experience on all devices.',
      tags: ['React Native', 'Expo', 'Styled Components'],
      image: PlaceHolderImages.find(p => p.id === 'project-5')!
    },
    {
      title: 'Project Six',
      description: 'An e-commerce platform with a custom backend and a modern, responsive frontend.',
