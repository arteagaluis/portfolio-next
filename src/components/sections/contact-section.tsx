    ...
    <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-secondary">
      <div className="container px-4 md:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl font-headline">{t('title')}</h2>
        ...
        <div className="mx-auto w-full max-w-md space-y-8">
            ...
            <div className="text-center text-muted-foreground">
              <p>{t('orDirectly')}</p>
              <a href={`mailto:${t('emailAddress')}`} className="font-medium text-primary hover:underline flex items-center justify-center gap-2">
