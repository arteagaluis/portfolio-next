...
export function HeroSection() {
  ...
  return (
    <section id="home" className="w-full bg-secondary flex justify-center">
        ...
        <div className="flex flex-col items-center justify-center space-y-6 text-center min-h-dvh pt-24 pb-12">
          <div className="space-y-4">
            <h1 className="font-bold tracking-tighter font-headline text-[2rem] sm:text-[2.5rem] lg:text-[3rem]">
              {t("title-start")} <TypingAnimation words={animatedWords} />{" "}
              {t("title-end")}
            </h1>
          ...
          <Button
            asChild
            className="px-6 py-3 md:px-7 md:py-3.5 lg:px-8 lg:py-4 text-base rounded-md"
          >
